<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:49:"./template/mobile/rainbow/goods/categoryList.html";i:1522317286;s:71:"/home/wwwroot/jinyifuqin.vip/template/mobile/rainbow/public/header.html";i:1522317286;s:72:"/home/wwwroot/jinyifuqin.vip/template/mobile/rainbow/public/top_nav.html";i:1522317286;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8" />
            ...
            <?php $j = '0'; if(is_array($goods_category_tree) || $goods_category_tree instanceof \think\Collection || $goods_category_tree instanceof \think\Paginator): if( count($goods_category_tree)==0 ) : echo "" ;else: foreach($goods_category_tree as $kk=>$vo): ?>
                <div class="branchList" >
                    ...
                    <div class="tp-bann"  data-id="<?php echo $j++; ?>">
                        <?php $pid =401;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1527332400 and end_time > 1527332400 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
